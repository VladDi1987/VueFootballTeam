                ...
                <div id="slider" class="slider">
                    <div class="slider__wrap">
                        <swiper :options="swiperOption" @slideChange="changeSwiperIndex" ref="mySwiper">
                            <swiper-slide class="slider__item" v-for="(img, index, id) in players.defender"
                ...
                <div class="statistics-body">
                    <div class="statistics__header">
                        <h2 class="statistics__head">
                            {{ players.defender[active].name}}
                        </h2>
                        <div class="statistics__tagline">
                            <span class="statistics__subtitle">
                                {{ players.defender[active].report.club}}
                            </span>
                            <span class="statistics__subtitle">/</span>
                            <span class="statistics__subtitle">
                                {{ players.defender[active].report.country}}
                            </span>
                        </div>
                    </div>
                    <div class="statistics-counter">
                        ...
                        <div class="statistics-counter__box">
                            <div class="statistics-counter__number">
                                {{players.defender[active].description.playedMinutes}}
                            </div>
                        ...
                        <div class="statistics-counter__box">
                            <div class="statistics-counter__number">
                                {{players.defender[active].description.wonWrestling}}
                            </div>
                            <p class="statistics-counter__info">Борьба</p>
                        </div>

                        <div class="statistics-counter__box">
                            <div class="statistics-counter__number">
                                {{players.defender[active].description.passedGoals}}
                            </div>
                        ...
                        <div class="statistics-counter__box">
                            <div class="statistics-counter__number">
                                {{players.defender[active].description.goal}}
                            </div>
                    ...
                    <div class="summary">
                        <transition-group name="staggered-fade" tag="ul" class="summary-list">
                            <li class="summary-list__item" v-for="(item, i) in  players.defender[active].brief" :key="i">
                                {{item}}
                            </li>
                        </transition-group>
                    </div>
                    <div class="btn-wrap">
                        <div class="btn btn_main"
                             :class="{ 'btn_selected': players.defender[active].selected}"
                             @click="addPlayer('defender', players.defender[active])">
                            {{ players.defender[active].selected ? 'Выбран' : 'Добавить'}}
                        </div>
                    </div>
                </div>
            </div>
